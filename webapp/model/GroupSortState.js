sap.ui.define([
	...
	return BaseObject.extend("com.sap.demo.customer.order.maintain.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.demo.customer.order.maintain.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "CompanyName");
			}
