...
sap.ui.define([
	...
	return BaseController.extend("com.sap.demo.customer.order.maintain.controller.Detail", {
		...
		onDelete: function() {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/CompanyName"),
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getModel().metadataLoaded().then(function() {
				var sObjectPath = this.getModel().createKey("BusinessPartnerSet", oParameter);
