sap.ui.define([
	...
	return BaseController.extend("com.sap.demo.customer.order.maintain.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("BusinessPartnerSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("BusinessPartnerSet", oData);
