sap.ui.define([
	...
	return BaseObject.extend("com.sap.demo.customer.order.maintain.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.demo.customer.order.maintain.model.ListSelector
		 */
		 ...
		 * @return {com.sap.demo.customer.order.maintain.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
