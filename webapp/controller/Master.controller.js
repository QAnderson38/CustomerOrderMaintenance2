/*global history */
sap.ui.define([
	"com/sap/demo/customer/order/maintain/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/sap/demo/customer/order/maintain/model/formatter",
	"sap/m/MessageBox"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox) {
	"use strict";

	return BaseController.extend("com.sap.demo.customer.order.maintain.controller.Master", {
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							BusinessPartnerID: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("BusinessPartnerID"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				BusinessPartnerID: encodeURIComponent(oItem.getBindingContext().getProperty("BusinessPartnerID"))
			}, bReplace);
		},
