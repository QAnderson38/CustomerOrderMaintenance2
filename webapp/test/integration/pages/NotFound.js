			...
			assertions: {
				...
				theNotFoundPageShouldSayResourceNotFound: function() {
					return this.waitFor({
						...
						success: function(oPage) {
							...
							Opa5.assert.strictEqual(oPage.getText(), oPage.getModel("i18n").getProperty("notFoundText"),
				...
				theNotFoundPageShouldSayObjectNotFound: function() {
					return this.waitFor({
						...
						success: function(oPage) {
							Opa5.assert.strictEqual(oPage.getTitle(), oPage.getModel("i18n").getProperty("detailTitle"),
								"The object text is shown as title");
